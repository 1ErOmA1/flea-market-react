...
import { itemPlus, itemMinus, removeItem } from '../../redux/cart/slice'
import type { CartItem } from '../../redux/cart/types';

const CartElement = (item: CartItem) => {
  ...
  return (
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <button disabled={item.count === 1} onClick={onClickMinus} className="button button--outline button--circle cart__item-count-minus">
